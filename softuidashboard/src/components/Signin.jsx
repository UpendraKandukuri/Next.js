    ...
    <div className="font-opensans max-h-screen">
      ...
      <div className="flex p-5">
            ...
            <form className="space-y-3 w-75">
              <div className="flex flex-col gap-0.5">
                ...
                <input
                  ...
                  className="border border-gray-300  focus:outline-blue-400 px-2 py-1 w-fit rounded"
                />
              </div>
              <div className="flex flex-col gap-0.5">
              ...
              <button className="bg-gradient-to-r from-blue-400 to-blue-900 text-xl text-white w-fit px-3 py-1 rounded-md">
                SIGN IN
              </button>
        ...
        <div>
          ...
          <Image src="/loginimage.svg" alt="loginimage" height={400} width={400} />
        </div>
      </div>
    </div>
  );
