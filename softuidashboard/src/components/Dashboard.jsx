  ...
  return (
    <div className="flex flex-col gap-7 font-opensans">
      ...
      <div className="p-3 flex flex-col gap-4">
        <div className="grid grid-cols-4 gap-4">
          <div className="p-2 bg-white rounded-md shadow-md flex justify-between items-center">
            ...
            <div className="bg-gradient-to-br from-pink-500 via-fuchsia-600 to-purple-700  p-2 rounded-md flex justify-center items-center h-12 w-12">
              <Image src="/money.png" alt="money" height={20} width={20} />
            </div>
          </div>
          <div className="p-2 bg-white rounded-md shadow-md flex justify-between items-center">
            <div className="flex flex-col gap-1">
            ...
            <div className="bg-gradient-to-br from-pink-500 via-fuchsia-600 to-purple-700  p-2 rounded-md flex justify-center items-center h-12 w-12">
              <Image src="/world.png" alt="world" height={20} width={20} />
            </div>
          </div>
          <div className="p-2 bg-white rounded-md shadow-md flex justify-between items-center">
            <div className="flex flex-col gap-1">
            ...
            <div className="bg-gradient-to-br from-pink-500 via-fuchsia-600 to-purple-700  p-2 rounded-md flex justify-center items-center h-12 w-12">
              <Image src="/paper.png" alt="paper" height={20} width={20} />
            </div>
          </div>
          <div className="p-2 bg-white rounded-md shadow-md flex justify-between items-center">
            <div className="flex flex-col gap-1">
            ...
            <div className="bg-gradient-to-br from-pink-500 via-fuchsia-600 to-purple-700  p-2 rounded-md flex justify-center items-center h-12 w-12">
              <Image src="/cart.png" alt="cart" height={20} width={20} />
            </div>
          </div>
        </div>
        <div className="flex gap-5">
          <div className="w-3/5  bg-white rounded-md shadow-md p-2 flex gap-2">
            ...
            <div className="bg-gradient-to-br from-pink-500 via-fuchsia-600 to-purple-700 py-4 rounded-md">
              <Image src="/rocket.png" alt="rocket" height={140} width={360} />
            </div>
          </div>
        ...
        <div className="flex gap-5">
          <div className="w-2/5 bg-white rounded-md shadow-md p-3 flex flex-col gap-4">
            <ActiveUsersChart />
            <div>
          ...
          <div className="w-3/5 bg-white p-3 rounded-md shadow-md flex flex-col gap-4">
            <div>
        ...
        <div className="flex gap-5">
          ...
          <div className="w-1/3 p-2 bg-white rounded-md shadow-md flex flex-col gap-4">
            ...
            <div className="space-y-1">
              <div className="flex gap-5">
                <Image src="/bell.svg" alt="bell" height={28} width={16} />
              ...
              <div className="flex gap-5">
                <Image src="/shape.svg" alt="bell" height={28} width={16} />
                <div className="flex flex-col">
              ...
              <div className="flex gap-5">
                <Image src="/coins.svg" alt="bell" height={28} width={16} />
                <div className="flex flex-col">
