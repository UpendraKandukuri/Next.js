                ...
                <tr className="border-b border-gray-300" key={index}>
                  <td className="px-3 py-3">
                    <div className="flex items-center space-x-2">
                      ...
                      <Image src={customer.image} alt={customer.fullName} height={32} width={32} />
                  ...
                  <td className="px-3 py-3">
                    <div className="flex items-center space-x-2">
                      {customer.paymentMethod === "VISA" && (
                        ...
                        <Image src='/visa.png' alt="visa" height={12} width={24} />
                      )}
                      {customer.paymentMethod === "MasterCard" && (
                        
                        <Image src='/mastercard.svg' alt="mastercard" height={12} width={24} />
                      )}
                  ...
                  <td className="px-3 py-3">
                    <div className="flex items-center space-x-2 justify-center">
                      ...
                      <Image src='/delete1.svg' alt="delete" height={20} width={20} className="cursor-pointer" onClick={() => handleClick(customer.id)}/>
                     
                      <Image src='/download.svg' alt="download" height={20} width={20} className="cursor-pointer"  onClick={() => handleDownload(customer)} />
